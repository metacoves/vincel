...
namespace WindowsFormsApp1
{
    ...
    public static class Signatures
    {
        ...
        {
            // ===== 360 系列 =====
            {"360safe", "360安全卫士，含捆绑安装组件"},
            {"360se", "360安全浏览器，含广告弹窗"},
            {"360chrome", "360极速浏览器"},
            {"360zip", "360压缩，含广告弹窗"},
            {"360desktop", "360桌面助手"},
            {"360wallpaper", "360壁纸"},
            ...
            {"softmgr", "360软件管家，含捆绑安装组件"},
            {"360softmgr", "360软件管家，含捆绑安装组件"},
            {"360update", "360更新程序"},
            {"360doctor", "360电脑专家"},
            {"360appmgr", "360应用管理器"},
            {"360game", "360游戏大厅"},
            ...
            {"easydrv", "EasyDrv驱动总裁，含捆绑安装组件"},
            {"itiankong", "IT天空驱动包，含捆绑安装组件"},
            {"wandrv", "WanDrv驱动助理"},
            ...
            {"彩云浏览器", "彩云浏览器，广告"},
            {"蚂蚁浏览器", "蚂蚁浏览器，含广告弹窗"},
            {"115浏览器", "115浏览器，含捆绑安装组件"},
            {"糖果浏览器", "糖果浏览器，广告"},
            {"飞鱼浏览器", "飞鱼浏览器，含捆绑安装组件"},
            {"瑞星浏览器", "瑞星浏览器，广告"},
            {"h5browser", "H5浏览器，含捆绑安装组件"},
            {"yabrowser", "Yandex浏览器（常随其他软件捆绑安装）"},
            {"ucbrowser", "UC浏览器电脑版，含广告弹窗"},
            ...
            {"ppstream", "PPS，广告弹窗"},
            {"funshion", "风行视频，广告"},
            {"baofeng", "暴风影音，含捆绑安装与广告弹窗"},
            {"stormplayer", "暴风影音"},
            {"verycd", "VeryCD电驴，含捆绑安装组件"},

            // ===== 输入法（广告弹窗型） =====
            {"sogouinput", "搜狗输入法，广告弹窗"},
            {"baiduinput", "百度输入法，含广告弹窗"},
            ...
            // ===== 工具箱 / 下载站捆绑器 =====
            {"wintoolbox", "Win工具箱，含广告弹窗"},
            {"wintoolsrv", "Win工具箱服务"},
            {"winlauncher", "Win工具箱启动器"},
            {"huajun", "华军下载器，含捆绑安装组件"},
            {"duote", "多特下载器，含捆绑安装组件"},
            {"downza", "下载之家捆绑器"},
            {"cr173", "统一下载站捆绑器"},
            {"xiazaiba", "下载吧捆绑器"},
            ...
            {"browsersafeguard", "浏览器卫士（含广告弹窗）"},
            {"websafeguard", "网页卫士（含广告弹窗）"},
            {"internetprotector", "上网保护器（含广告弹窗）"},
            {"onlinenetguard", "网络卫士（含广告弹窗）"},
            ...
            {"7k7kbox", "7k7k游戏盒，弹窗"},
            {"duowanbox", "多玩游戏盒，广告"},
            {"17173box", "17173游戏盒，含捆绑安装组件"},
            {"wanmei", "完美游戏盒子，弹窗"},
            {"37game", "37游戏盒子，广告"},
            {"9377", "9377游戏盒子，弹窗"},
            {"youxikuang", "游戏狂盒子，含捆绑安装组件"},
            {"xygame", "XY游戏盒子，广告"},
            {"leihuo", "雷火游戏盒子，弹窗"}
        };
